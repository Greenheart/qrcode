...
import BitMatrix from './bit-matrix.ts'
import * as AlignmentPattern from './alignment-pattern.ts'
import * as FinderPattern from './finder-pattern.ts'
import * as MaskPattern from './mask-pattern.ts'
import * as ECCode from './error-correction-code.ts'
import ReedSolomonEncoder from './reed-solomon-encoder.ts'
